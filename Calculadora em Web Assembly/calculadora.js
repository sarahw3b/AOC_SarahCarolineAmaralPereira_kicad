...
var _calcular = Module['_calcular'] = makeInvalidEarlyAccess('_calcular');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['calcular'] != 'undefined', 'missing Wasm export: calcular');
  _calcular = Module['_calcular'] = createExportWrapper('calcular', 0);
